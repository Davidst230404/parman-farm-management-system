...
<div class="ks-data-section">
    ...
    {{-- Tabs header with filter action --}}
    <div class="ks-data-header" style="border-bottom: 1px solid #E5E7EB; padding-bottom: 0;">
        {{-- Filter Tabs --}}
        <div class="ks-tabs" role="tablist" style="border-bottom: none; padding-left: 0;">
